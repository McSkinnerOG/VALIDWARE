...
namespace MC_CSHARP
{
    ...
    {
        // 80 A5 3C 35 F7 7F 00 00 20 C2 05 EF 06 02 00 00 08 00 00 00 00 00 00 00 05 00
        //public static string LocalPlayer = "Minecraft.Windows.exe+0x041DF848,40,0,20,C8,640,100";
        public static string LocalPlayer = "Minecraft.Windows.exe+0x0423C2B8,8,18,B8";
